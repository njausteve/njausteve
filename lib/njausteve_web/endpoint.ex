defmodule NjausteveWeb.Endpoint do
  use Sentry.PlugCapture
  use Phoenix.Endpoint, otp_app: :njausteve
  ...
  @session_options [
    store: :cookie,
    key: "_njausteve_key",
    signing_salt: "DbUzH7Mx"
  ]

  socket "/socket", NjausteveWeb.UserSocket,
    websocket: true,
    longpoll: false
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :njausteve
  end
  ...
  plug Pow.Plug.Session, otp_app: :njausteve
  plug NjausteveWeb.Router
